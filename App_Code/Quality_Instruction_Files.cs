...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(Quality_Instruction_FilesMetadata))]
    [DisplayName("Pliki Instrukcji Kontroli")]
    public partial class Quality_Instruction_Files
    {

        public Quality_Instruction_Files()
        {
            //
    ...
    public class Quality_Instruction_FilesMetadata
    {
        ...
        [UIHint("FileUpload")]
        [FileUpload(
            FileUrl = "~/quality_instruction_files/{0}",
