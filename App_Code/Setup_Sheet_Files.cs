...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(Setup_Sheet_FilesMetadata))]
    [DisplayName("Pliki Arkuszy Ustawczych")]
    public partial class Setup_Sheet_Files
    {

        public Setup_Sheet_Files()
        {
            //
    ...
    public class Setup_Sheet_FilesMetadata
    {
