...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(CNC_Program_FilesMetadata))]
    [DisplayName("Pliki Programów CNC")]
    public partial class CNC_Program_Files
    {

        public CNC_Program_Files()
        {
            //
    ...
    public class CNC_Program_FilesMetadata
    {
