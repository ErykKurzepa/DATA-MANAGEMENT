...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(Quality_Chart_IndexMetadata))]
    [DisplayName("Rewizji Kart Kontroli")]
    ...
    public class Quality_Chart_IndexMetadata
    {
        ...
        [Display(Name = "Karta kontroli", Order = 2)]
        public object Quality_Chart;
