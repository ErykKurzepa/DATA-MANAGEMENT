...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(Technology_Dwg_FilesMetadata))]
    [DisplayName("Pliki Rysunków Technologicznych")]
    public partial class Technology_Dwg_Files
    {

        public Technology_Dwg_Files()
        {
            //
    ...
    public class Technology_Dwg_FilesMetadata
    {
        ...
        [UIHint("FileUpload")]
        [FileUpload(
            FileUrl = "~/technology_dwg_files/{0}",
