...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(CNC_Subprogram_FilesMetadata))]
    [DisplayName("Pliki Podprogramów CNC")]
    public partial class CNC_Subprogram_Files
    {

        public CNC_Subprogram_Files()
        {
            //
    ...
    public class CNC_Subprogram_FilesMetadata
    {
