...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(Quality_Chart_FilesMetadata))]
    [DisplayName("Pliki Kart Kontroli")]
    public partial class Quality_Chart_Files
    {

        public Quality_Chart_Files()
        {
            //
    ...
    public class Quality_Chart_FilesMetadata
    {
