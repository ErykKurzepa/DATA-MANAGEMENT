...
namespace YASA_PL
{
    ...
    [MetadataType(typeof(CNC_ProgramMetadata))]
    [DisplayName("Programy CNC")]
    ...
    public class CNC_ProgramMetadata
    {

        [UIHint("IdCNC_Program")]
        ...
        [Display(Name = "Wykaz podprogramów", Order = 6)]
        public object CNC_Subprogram;
