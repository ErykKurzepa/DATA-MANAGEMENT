...
<script RunAt="server">
    ...
    public string custom_con_string = "Data Source=TECHNOLOG-DELL\\SQLEXPRESS;Integrated Security=true;Initial Catalog=YASA_PL";
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        DefaultModel.RegisterContext(typeof(YASA_PL.YASA_PLContainer), new ContextConfiguration() { ScaffoldAllTables = true });
        ...
        routes.Add(new DynamicDataRoute("{table}/{action}.aspx")
        {
            Constraints = new RouteValueDictionary(new
            {
                action = "ZakonczPowiadomienie|AnulujPowiadomienie",
           ...
           routes.Add(new DynamicDataRoute("{table}/{action}.aspx")
        {
            Constraints = new RouteValueDictionary(new
            {
                action = "ManageSelections",
                table = "Tool_ElementSet"
            }),
            Model = DefaultModel
        });
                    ...
                    routes.Add(new DynamicDataRoute("{table}/{action}.aspx")
        {
            ...
            {
                action = "ManageSelections",
                table = "Technology_InstructionSet"
            }),
            Model = DefaultModel
        });
