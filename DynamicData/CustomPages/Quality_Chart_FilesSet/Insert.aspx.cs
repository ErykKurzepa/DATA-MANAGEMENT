...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["Quality_Chart_IndexId"];
            if (value != null)
                Response.Redirect("~/Quality_Chart_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    {
        YASA_PL.Quality_Chart_Files c = (YASA_PL.Quality_Chart_Files)e.Entity;
        if (c != null)
        {
            ...
            if (c.filePath != null)
            {
                ...
                String fileUrl = "~/quality_chart_files/" + c.filePath;
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["Quality_Chart_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/Quality_Chart_IndexSet/Details.aspx?Id=" + value3);
        }
