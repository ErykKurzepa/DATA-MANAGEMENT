<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeFile="AnulujPowiadomienie.aspx.cs" Inherits="Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="DDSubHeader">Anulowanie powiadomienia</h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="Czy na pewno chcesz anulować to powiadomienie?"/>
            </td>
</tr>
<tr class="td">
...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="Title" DataField="Name" />
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton runat="server" CommandName="Update" Text="Anuluj powiadomienie" /> | &nbsp;
