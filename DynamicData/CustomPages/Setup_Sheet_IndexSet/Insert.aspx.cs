...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["Setup_SheetId"];
            if (value1 != null)
                Response.Redirect("~/Setup_SheetSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.Setup_Sheet_Index c = (YASA_PL.Setup_Sheet_Index)e.Entity;
        if (c != null)
        {
    ...
    {
        string value = Request.QueryString["Setup_SheetId"];
        if (value != null)
        {
            Session["Record_Info"] = "Rewizja została dodana";
            Response.Redirect("~/Setup_SheetSet/Details.aspx?Id=" + value);
        }
