...
<tr class="td">
            ...
            <td colspan="6">
                ...
                <asp:DynamicControl Visible="false"  runat="server" ID="DynamicControl4" DataField="Fixture" Mode="Insert"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Typ dokumentu"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl6" DataField="Fixture_Document_Type" Mode="Insert"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Index" Mode="Insert"/>
                 </td>
</tr>
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="File_title" Mode="Insert"/>
                 </td>
</tr>
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
