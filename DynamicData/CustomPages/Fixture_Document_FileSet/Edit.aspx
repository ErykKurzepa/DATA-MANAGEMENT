...
<tr class="td">
       ...
       <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl6" DataField="Fixture_Document_Type" Mode="Edit"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
          ...
          <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="File_title" Mode="Edit"/>
                 </td>
</tr>
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
