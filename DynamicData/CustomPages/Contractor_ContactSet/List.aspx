...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="DD">
                 <b>Rekordy:</b> <asp:TextBox ID="TBSearch" CssClass="DDTextBox" runat="server"></asp:TextBox> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>Filtry: </b> 
                ...
                <asp:QueryExtender ID="QE1" runat="server" TargetControlID="GridDataSource">
                    ...
                    <asp:SearchExpression DataFields="F_Name, L_Name, Position, Department, W_Phone_No, M_Phone_No, Email, Description " ComparisonType="InvariantCultureIgnoreCase" SearchType="Contains">
