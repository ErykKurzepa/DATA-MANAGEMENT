...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Tool_Type"  Mode="Edit"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="Title" DataField="Catalog_number" Mode="Edit"/>
                 </td>
</tr>
