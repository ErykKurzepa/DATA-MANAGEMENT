<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeFile="EditZakoncz.aspx.cs" Inherits="Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="DDSubHeader">Zakończenie zamówienia</h2>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="Czy na pewno chcesz potwierdzić realizację zamówienia?"/>
     ...
     <td class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="Title" DataField="Title" />
                        ...
                        <tr class="td">
     <td class="DDLightHeader">
                <asp:Label runat="server" Text="Podaj datę realizacji zamówienia:"/>
            </td>
            <td >
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Date_delivered" Mode="Edit" />
                 </td>
