...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["Quality_ChartId"];
            if (value1 != null)
                Response.Redirect("~/Quality_ChartSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.Quality_Chart_Index c = (YASA_PL.Quality_Chart_Index)e.Entity;
        if (c != null)
        {
    ...
    {
        string value = Request.QueryString["Quality_ChartId"];
        if (value != null)
        {
            Session["Record_Info"] = "Rewizja została dodana";
            Response.Redirect("~/Quality_ChartSet/Details.aspx?Id=" + value);
        }
