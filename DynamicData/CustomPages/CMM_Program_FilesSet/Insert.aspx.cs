...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["CMM_Program_IndexId"];
            if (value != null)
                Response.Redirect("~/CMM_Program_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["CMM_Program_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/CMM_Program_IndexSet/Details.aspx?Id=" + value3);
        }
