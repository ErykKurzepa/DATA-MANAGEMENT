...
<tr class="td">
        ...
        <td class="User_page_header" colspan="6">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Production_material" Mode="Insert"/>
                 </td>
</tr>
                                 <tr class="td">
        <td class="User_page_header" colspan="6">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Customer_Part_Index" Mode="Insert"/>
                 </td>
