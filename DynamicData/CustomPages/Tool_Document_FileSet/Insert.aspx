...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="filePath" Mode="Insert"/>
                                  ...
                                  <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Typ pliku"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Tool_Document_Type" Mode="Insert"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                ...
                <asp:DynamicControl Visible="false"  runat="server" ID="DynamicControl4" DataField="Tool" Mode="Insert"/>
                 <asp:DynamicControl Visible="false"  runat="server" ID="DynamicControl6" DataField="Tool_Element" Mode="Insert"/>
                 </td>
</tr>                                           
