...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["Technology_IndexId"];
            if (value1 != null)
                Response.Redirect("~/Technology_IndexSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.Technology_Stage c = (YASA_PL.Technology_Stage)e.Entity;
        if (c != null)
        {
