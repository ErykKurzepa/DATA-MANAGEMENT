...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O OPERACJI W TECHNOLOGII PRODUKCJI"/>
            </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Numer operacji"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Number" Mode="Insert"/>
                 </td>
</tr>

                                    <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Tytuł operacji"/>
            </td>
            <td colspan="6">
...
<tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Opis operacji"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="Descript" DataField="Description" Mode="Insert"/>
                  <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Technology_Index" Mode="Insert" Visible="false"/>
                 </td>
</tr>
 <tr class="td">
        <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="DANE OPERACJI"/>
            </td></tr>

<tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Wymagany czas [min]"/>
            </td>
            <td colspan="6">
               <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Operation_time" Mode="Insert"/>
                 </td>
