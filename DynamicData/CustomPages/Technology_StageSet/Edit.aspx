...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Number" Mode="Edit"/>
                 </td>
</tr>
            ...
            <td style="width:150px">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Name" Mode="Edit"/>
                 </td>
...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="Descript" DataField="Description" Mode="Edit"/>
...
<tr class="td">
            ...
            <td colspan="6">
               <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Operation_time" Mode="Edit"/>
                 </td>
