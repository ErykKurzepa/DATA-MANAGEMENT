...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            string value1 = Request.QueryString["Technology_InstructionId"];
            if (value1 != null)
                Response.Redirect("~/Technology_InstructionSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.Technology_Instruction_Index c = (YASA_PL.Technology_Instruction_Index)e.Entity;
        if (c != null)
        {
    ...
    {
        string value = Request.QueryString["Technology_InstructionId"];
        if (value != null)
        {
            Session["Record_Info"] = "Rekord został dodany";
            Response.Redirect("~/Technology_InstructionSet/Details.aspx?Id=" + value);
        }
