...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EntitySetName="Technology_InstructionSet"
        EnableUpdate="true"
        Include="Technology_Instruction_Indexes"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.Technology_InstructionId FROM Technology_Instruction_IndexSet AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl='<%#"~/Technology_InstructionSet/Details.aspx?Id=" + Eval("Technology_InstructionId") %>'>Pokaż Wszystkie Rewizje</asp:DynamicHyperLink> | &nbsp;
                                   </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server"
                ContextTypeName="YASA_PL.YASA_PLContainer"
                EntitySetName="Technology_FilesSet"
                Where="it.Technology_Instruction_IndexId=@CPartIndexId">
                <WhereParameters>
                    <asp:QueryStringParameter Name="CPartIndexId" Type="Int32" QueryStringField="Id" Direction="Input" />
                </WhereParameters>
            </asp:EntityDataSource>
