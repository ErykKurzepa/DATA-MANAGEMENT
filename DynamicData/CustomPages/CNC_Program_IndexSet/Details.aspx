...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EnableUpdate="true"
        Include="CNC_Program_Index"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.CNC_ProgramId FROM CNC_Program_IndexSet AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O REWIZJI PROGRAMU CNC"/>
            </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="CNC_Status"/>
                 </td>
</tr>
                          <tr class="td">
            <td style="width:150px" class="DDLightHeader">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl='<%#"~/CNC_ProgramSet/Details.aspx?Id=" + Eval("CNC_ProgramId") %>'>Pokaż Wszystkie Rewizje</asp:DynamicHyperLink> | &nbsp;
                                   </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <h2 class="DDSubHeader">Pliki CNC</h2>
            <asp:DynamicDataManager runat="server">
                <DataControls>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server"
                ContextTypeName="YASA_PL.YASA_PLContainer"
                EntitySetName="CNC_Program_FilesSet"
                Where="it.CNC_Program_IndexId=@CPartIndexId">
                <WhereParameters>
                    <asp:QueryStringParameter Name="CPartIndexId" Type="Int32" QueryStringField="Id" Direction="Input" />
                </WhereParameters>
            </asp:EntityDataSource>
