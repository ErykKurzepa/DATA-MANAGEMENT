...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["Setup_Sheet_IndexId"];
            if (value != null)
                Response.Redirect("~/Setup_Sheet_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    {
        YASA_PL.Setup_Sheet_Files c = (YASA_PL.Setup_Sheet_Files)e.Entity;
        if (c != null)
        {
            ...
            if (c.filePath != null)
            {
                ...
                String fileUrl = "~/setup_sheet_files/" + c.filePath;
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["Setup_Sheet_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/Setup_Sheet_IndexSet/Details.aspx?Id=" + value3);
        }
