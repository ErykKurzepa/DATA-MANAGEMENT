...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="DDSubHeader">Klient:</h2>
...
<tr class="td">
     ...
     <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Country1" />
                 </td>
</tr>
                        <tr class="td">
            <td style="width:150px" class="DDLightHeader">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="OPCJE"/>
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <div ID="DisableEdit" class="">
                                <asp:DynamicHyperLink ID="EditDynamicHyperLink" runat="server" Action="Edit" Text="Edytuj" Enabled="true" />  | &nbsp;
                               
                                 <asp:HyperLink ID="ListHyperLink" runat="server" NavigateUrl="~/CustomerSet/List.aspx">Pokaż Wszystkich Klientów</asp:HyperLink> | &nbsp;
                                <asp:DynamicHyperLink ID="DetaleDynamicHyperLink" runat="server" NavigateUrl='<%# "~/Customer_PartSet/List.aspx?CustomerId=" + Eval("Id") %>' >Pokaż Detale Tego Klienta</asp:DynamicHyperLink> | &nbsp;
                             </div>
                            </td>
                        </tr>
                    </table>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="Customer_ContactSet1"
                Where="it.CustomerId=@CPartId">
                <WhereParameters>
