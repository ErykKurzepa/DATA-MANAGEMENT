 ...
 <asp:TextBox ID="TBSearch" CssClass="DDTextBox" runat="server" ></asp:TextBox> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <b>Filtry:</b> 
                ...
                <asp:QueryExtender ID="QE1" runat="server" TargetControlID="GridDataSource">
                    ...
                    <asp:SearchExpression  DataFields="Name, Address, City, Postal_Code, Phone, Email, Www, Description" ComparisonType="InvariantCultureIgnoreCase" SearchType="Contains">
...
<asp:Button runat="server" OnClick="clear_search"  Text="Wyczyść"/>
           ...
           <hr />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                     <asp:DynamicField DataField="Id" />
                          ...
                          <asp:DynamicField DataField="Country1" />
            ...
            <div ID="InsertHyperLinkDiv" class="DDBottomHyperLink">
