...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EntitySetName="CMM_ProgramSet"
        EnableUpdate="true"
        Include="CMM_Program_Index"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.CMM_ProgramId FROM CMM_Program_IndexSet AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O REWIZJI PROGRAMU CMM"/>
            </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="CMM_Status"/>
                 </td>
</tr>
                          <tr class="td">
            <td style="width:150px" class="DDLightHeader">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl='<%#"~/CMM_ProgramSet/Details.aspx?Id=" + Eval("CMM_ProgramId") %>'>Pokaż Wszystkie Rewizje</asp:DynamicHyperLink> | &nbsp;
                                   </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <h2 class="DDSubHeader">Pliki CMM</h2>
            <asp:DynamicDataManager runat="server">
                <DataControls>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" EnableDelete="true"
                ContextTypeName="YASA_PL.YASA_PLContainer"
                EntitySetName="CMM_Program_FilesSet"
                Where="it.CMM_Program_IndexId=@CPartIndexId">
                <WhereParameters>
                    <asp:QueryStringParameter Name="CPartIndexId" Type="Int32" QueryStringField="Id" Direction="Input" />
                </WhereParameters>
            </asp:EntityDataSource>
