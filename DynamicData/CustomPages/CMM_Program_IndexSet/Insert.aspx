...
<tr class="td">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="CMM_Status" Mode="Insert"/>
                 </td>
</tr>
                          <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Date_approved" Mode="Insert"/>
                 <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="CMM_Program" Mode="Insert" Visible="false"/>
                 </td>
</tr>
