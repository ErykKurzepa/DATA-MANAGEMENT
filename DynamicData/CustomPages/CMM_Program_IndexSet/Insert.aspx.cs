...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["CMM_ProgramId"];
            if (value1 != null)
                Response.Redirect("~/CMM_ProgramSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.CMM_Program_Index c = (YASA_PL.CMM_Program_Index)e.Entity;
        if (c != null)
        {
    ...
    {
        string value = Request.QueryString["CMM_ProgramId"];
        if (value != null)
        {
            Session["Record_Info"] = "Rewizja została dodana";
            Response.Redirect("~/CMM_ProgramSet/Details.aspx?Id=" + value);
        }
