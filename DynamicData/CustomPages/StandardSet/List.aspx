...
<asp:Button runat="server" OnClick="clear_search"  Text="Wyczyść"/>
           ...
           <hr />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                    ...
                    <asp:DynamicField DataField="Description" /> 
                            <asp:DynamicField DataField="Organization" />
                   <%-- <asp:DynamicField DataField="Date_created_modified" />--%>
                    
                   <%-- <asp:DynamicField DataField="FormTemplate_Files" />--%>
            ...
            <div class="DDBottomHyperLink">
                <asp:DynamicHyperLink ID="InsertHyperLink" runat="server" Action="Insert"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj Normę</asp:DynamicHyperLink> | &nbsp;
             <asp:DynamicHyperLink ID="DynamicHyperLink1" runat="server" NavigateUrl="~/OrganizationSet/Insert.aspx"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj Wydawcę Norm</asp:DynamicHyperLink> 
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
