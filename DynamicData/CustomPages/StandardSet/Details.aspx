...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O NORMIE"/>
            </td>
</tr>
                                <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Wydawca normy"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Organization" />
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Numer normy"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Number"/>
                                                     ...
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Tytuł normy"/>
            </td>
            <td colspan="6">
...
<tr class="td">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:DynamicHyperLink runat="server" Action="Edit" Text="Edytuj" ID="EditDynamicHyperLink" /> | &nbsp;
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl="~/StandardSet/List.aspx">Pokaż Wszystkie Normy</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <br />
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" EnableDelete="true"
                ...
                EntitySetName="Standard_FilesSet"
                Where="it.StandardId=@CPartIndexId">
                <WhereParameters>
            ...
            <asp:GridView ID="GridViewCustomer_Part_Index_Files" runat="server" AllowPaging="True" AllowSorting="True" CssClass="DDGridView" OnRowDeleted="GridViewCustomer_Part_Index_Files_RowDeleted"
                ...
                <Columns>
                   ...
                   <asp:DynamicField DataField="Index_date" HeaderText="Data rewizji" />
                     
                      <asp:TemplateField HeaderText="Opis rewizji" ItemStyle-Width="65%">
    <ItemTemplate> 
      <asp:Label ID="opiszmina" Runat="Server" 
                Text='<%#((Eval("Index_description")).ToString().Replace(Environment.NewLine, "<br/>"))%>' />
    </ItemTemplate>
  </asp:TemplateField>
