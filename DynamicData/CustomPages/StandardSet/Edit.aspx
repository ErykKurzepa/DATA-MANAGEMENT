...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Organization" Mode="Edit"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Title" Mode="Edit"/>
                 </td>
</tr>
<tr class="td">
            <td style="width:150px" class="DDLightHeader">
