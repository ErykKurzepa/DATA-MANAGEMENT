 ...
 <asp:TextBox ID="TBSearch" CssClass="DDTextBox" runat="server" ></asp:TextBox> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   <b>Filtry:</b> 
                ...
                <asp:QueryExtender ID="QE1" runat="server" TargetControlID="GridDataSource">
                    ...
                    <asp:SearchExpression DataFields="Name, Number, Description" ComparisonType="InvariantCultureIgnoreCase" SearchType="Contains">
           ...
           <hr />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                    ...
                    <asp:DynamicField DataField="Number" HeaderText="Numer detalu /<br>Numer rysunku" />
                     <asp:DynamicField DataField="Customer" />
                    <asp:DynamicField DataField="Name" />
                    
                    
                    <asp:DynamicField DataField="Description" />
          <%--          <asp:DynamicField DataField="Customer_Contact_technology" />
                     <asp:DynamicField DataField="Customer_Contact_quality" />
                     <asp:DynamicField DataField="Customer_Contact_technology" />--%>
