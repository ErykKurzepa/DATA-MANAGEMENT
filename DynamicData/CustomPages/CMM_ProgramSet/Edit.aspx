...
<tr class="td">
            ...
            <td style="width:250px">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="CNC_Machine" Mode="Edit"/>
                 </td>
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Fixture" Mode="Edit"/>
                 </td>
                               <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Arkusz ustawczy"/>
            </td>
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Setup_Sheet" Mode="Edit"/>
                 </td>
</tr>
