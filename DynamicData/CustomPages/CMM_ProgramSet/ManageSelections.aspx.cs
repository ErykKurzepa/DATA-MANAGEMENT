...
public partial class List : System.Web.UI.Page
{
    ...
    private void AddSelections(List<int> selectionIds, List<int> selectionIds_Unchecked)
    {
        ...
        using (SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["custom_connection_YASA_PLContainer"].ConnectionString))
        {
            ...
            {
                SqlCommand cmd0 = new SqlCommand("DELETE FROM dbo.Technology_StageCMM_Program  WHERE  [Technology_Stage_Id] = (@etap) AND [CMM_Program_Id] = (@mach)", con);
            ...
            {
                    SqlCommand cmd1 = new SqlCommand("INSERT INTO dbo.Technology_StageCMM_Program ([Technology_Stage_Id], [CMM_Program_Id]) VALUES (@tool, @toolelement)", con);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (c != null)
        {
            ...
            {
                con.Open();
                SqlCommand cmd0 = new SqlCommand("SELECT COUNT(*) FROM dbo.Technology_StageCMM_Program  WHERE  [Technology_Stage_Id] = (@etap) AND [CMM_Program_Id] = (@element)", con);
                cmd0.Parameters.AddWithValue("@etap", value);
