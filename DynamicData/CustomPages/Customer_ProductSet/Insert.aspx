...
<tr class="td">
          ...
          <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Customer" Mode="Insert"/>
                 </td></tr>
                      <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Number" Mode="Insert"/>
                 </td>
</tr>     
       <tr class="td">
            <td style="width:150px" class="DDLightHeader">
