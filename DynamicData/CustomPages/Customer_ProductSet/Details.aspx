...
<tr class="td">
          ...
          <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Customer"/>
                      ...
                      <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Numer produktu<br>/ numer rysunku"/>
            </td>
            <td colspan="6">
       ...
       <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Nazwa produktu"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Name"/>
                    ...
                    <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Opis produktu"/>
            </td>
            <td colspan="6">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="OPCJE"/>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:DynamicHyperLink ID="ListHyperLink" runat="server" Action="List">Pokaż wszystkie produkty</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="Customer_Product_IndexSet"
                Where="it.Customer_ProductId=@CPartId">
                <WhereParameters>
