...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EntitySetName="Quality_InstructionSet"
        EnableUpdate="true"
        Include="Quality_Instruction_Index"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.Quality_InstructionId FROM Quality_Instruction_IndexSet AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O INSTRUKCJI KONTROLI"/>
            </td>
</tr>
                               <tr class="td">
...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O REWIZJI INSTRUKCJI KONTROLI"/>
            </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl='<%#"~/Quality_InstructionSet/Details.aspx?Id=" + Eval("Quality_InstructionId") %>'>Pokaż Wszystkie Rewizje</asp:DynamicHyperLink> | &nbsp;
                                   </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server"
                ContextTypeName="YASA_PL.YASA_PLContainer"
                EntitySetName="Quality_Instruction_FilesSet"
                Where="it.Quality_Instruction_IndexId=@CPartIndexId">
                <WhereParameters>
                    <asp:QueryStringParameter Name="CPartIndexId" Type="Int32" QueryStringField="Id" Direction="Input" />
                </WhereParameters>
            </asp:EntityDataSource>
