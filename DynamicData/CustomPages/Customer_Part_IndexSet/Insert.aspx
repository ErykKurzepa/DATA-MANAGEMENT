  ...
  <tr class="td">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Date_received" Mode="Insert"/>
                 <asp:DynamicControl  runat="server" ID="DynamicControl6" DataField="Customer_Part" Mode="Insert" Visible="false"/>
                 <asp:DynamicControl  runat="server" ID="DynamicControl7" DataField="Customer_Product_Index" Mode="Insert" Visible="false"/>
                 </td>
          </tr>
