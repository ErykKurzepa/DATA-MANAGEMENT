...
public partial class Details : System.Web.UI.Page {
    ...
    protected void Page_Init(object sender, EventArgs e) {
        ...
        string value2 = Request.QueryString["edit"];
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        HyperLink2.NavigateUrl = "~/Customer_FilesSet/Insert.aspx?Customer_Part_IndexId=" + value;
        HyperLink4.NavigateUrl = "~/TechnologySet/Insert.aspx?Customer_Part_IndexId=" + value;
        ...
        if (!(Roles.IsUserInRole("Technology_List") || Roles.IsUserInRole("Admin")))
        {
            foreach (GridViewRow row in GridViewTechnologie.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
