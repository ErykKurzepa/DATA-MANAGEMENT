...
<b>Rekordy:</b> 
 ...
 <asp:DynamicValidator runat="server" ID="GridViewValidator" ControlToValidate="GridView1" Display="None" CssClass="DDValidator" />
                ...
                <asp:QueryExtender ID="QE1" runat="server" TargetControlID="GridDataSource" >
                    ...
                    <asp:SearchExpression DataFields="Name, Address, City, Postal_code, Email, Www, Description, Phone"
                         ComparisonType="InvariantCultureIgnoreCase" SearchType="Contains">
           ...
           <hr />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                    ...
                    <asp:DynamicField DataField="Contractor_category" />
                    ...
                    <asp:DynamicField DataField="Www" />
            ...
            <div class="DDBottomHyperLink">
                ...
                <asp:HyperLink ID="HyperLink2" runat="server"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj branżę</asp:HyperLink> | &nbsp;
