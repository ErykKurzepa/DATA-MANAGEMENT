...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl10" DataField="Contractor_category" Mode="Edit"/>
                 </td>
</tr>
                        <tr class="td">
            <td style="width:150px" class="DDLightHeader">
     ...
     <tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Country" Mode="Edit"/>
                 </td>
</tr>
                        <tr class="td">
            <td style="width:150px" class="DDLightHeader">
