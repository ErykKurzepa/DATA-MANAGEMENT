...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
       if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["CNC_ProgramId"];
            if (value1 != null)
                Response.Redirect("~/CNC_ProgramSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.CNC_Subprogram c = (YASA_PL.CNC_Subprogram)e.Entity;
        if (c != null)
        {
    ...
    protected void FormView1_ItemInserted(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        if (value != null)
        {
            Session["Record_Info"] = "Podprogram została dodana";
