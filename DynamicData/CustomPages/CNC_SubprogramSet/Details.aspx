...
<tr class="td">
            ...
            <td style="width:250px">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="CNC_Program" />
                 </td>
 ...
 <tr class="td">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink2" runat="server" NavigateUrl='<%# "~/CNC_ProgramSet/Details.aspx?Id="+Eval("CNC_Program.Id") %>'>Pokaż Wszystkie Podprogramy CNC</asp:DynamicHyperLink> | &nbsp;
            ...
            <h2 class="DDSubHeader">Wykaz rewizji podprogramu</h2>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="CNC_Subprogram_IndexSet"
                Where="it.CNC_SubprogramId=@CPartId2">
                <WhereParameters>
