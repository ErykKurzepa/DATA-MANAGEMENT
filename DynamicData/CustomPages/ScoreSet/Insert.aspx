...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl6" DataField="Contractor_Order" Mode="Insert"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Price" Mode="Insert"/>
                 </td>
</tr>
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Quality" Mode="Insert"/>
                 </td>
</tr>
<tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Delivery_time" Mode="Insert"/>
                 </td>
</tr>
                          <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Contact" Mode="Insert"/>
                 </td>
</tr>
                             <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Description" Mode="Insert"/>
                 </td>
</tr>
                            <tr class="td">
        <td class="User_page_header" colspan="6">
