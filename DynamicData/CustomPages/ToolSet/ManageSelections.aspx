...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h2 class="DDSubHeader">Wybierz Narzędzia które chcesz przypisać do programu CNC</h2>
    <hr />
                ...
                RowStyle-CssClass="td" HeaderStyle-CssClass="th" CellPadding="6" AutoGenerateColumns="false">
                 <Columns>
                    ...
                    <asp:DynamicField DataField="Name" />
                     ...
                     <asp:DynamicField DataField="Tool_Element" HeaderText="Elementy narzędzia" />
                     <%--<asp:DynamicField DataField="CNC_Machine" />--%>
                      <%--<asp:DynamicField DataField="ToolCNC_Program" />--%>
