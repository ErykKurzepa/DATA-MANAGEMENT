...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["Technology_Instruction_IndexId"];
            if (value != null)
                Response.Redirect("~/Technology_Instruction_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    {
        YASA_PL.Technology_Files c = (YASA_PL.Technology_Files)e.Entity;
        if (c != null)
        {
            ...
            if (c.filePath != null)
            {
                ...
                String fileUrl = "~/work_instruction_files/" + c.filePath;
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["Technology_Instruction_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Rekord został dodany";
            Response.Redirect("~/Technology_Instruction_IndexSet/Details.aspx?Id=" + value3);
        }
