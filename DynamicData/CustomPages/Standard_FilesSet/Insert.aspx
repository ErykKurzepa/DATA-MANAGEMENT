...
<tr class="td">
            ...
            <td colspan="6">
                ...
                <asp:DynamicControl Visible="false"  runat="server" ID="DynamicControl4" DataField="Standard" Mode="Insert"/>
                 </td>
</tr>
                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Index_date" Mode="Insert"/>
                 </td>
</tr>
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Index_description" Mode="Insert"/>
                 </td>
</tr>
