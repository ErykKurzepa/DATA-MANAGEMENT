...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        if (e.CommandName == DataControlCommands.CancelCommandName)
        {
            ...
            string value = Request.QueryString["Standard_FilesId"];
            if (value != null)
                Response.Redirect("~/Standard_FilesSet/Details.aspx?Id=" + value);
    ...
    {
        string value = Request.QueryString["StandardId"];
        if (value != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/StandardSet/Details.aspx?Id=" + value );
        }
