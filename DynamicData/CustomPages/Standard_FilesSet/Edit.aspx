...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Index" Mode="Edit"/>
                 </td>
</tr>
      <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl6" DataField="Index_date" Mode="Edit"/>
                 </td>
</tr>
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl1" DataField="Index_description" Mode="Edit"/>
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Standard" Mode="Edit" Visible="false"/>
                 </td>
</tr>
