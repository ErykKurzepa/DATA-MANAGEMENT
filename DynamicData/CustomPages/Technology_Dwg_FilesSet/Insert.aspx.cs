...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["Technology_Dwg_IndexId"];
            if (value != null)
                Response.Redirect("~/Technology_Dwg_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["Technology_Dwg_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Rekord został dodany";
            Response.Redirect("~/Technology_Dwg_IndexSet/Details.aspx?Id=" + value3);
        }
