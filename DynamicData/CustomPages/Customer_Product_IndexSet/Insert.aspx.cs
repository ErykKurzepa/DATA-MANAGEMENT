...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            string value1 = Request.QueryString["Customer_ProductId"];
            if (value1 != null)
                Response.Redirect("~/Customer_ProductSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.Customer_Product_Index c = (YASA_PL.Customer_Product_Index)e.Entity;
        if (c != null)
        {
