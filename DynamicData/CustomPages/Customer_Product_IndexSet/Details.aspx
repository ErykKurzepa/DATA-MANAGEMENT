...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 ...
 <asp:Label ID="Label1" runat="server" Text="" CssClass="DDValidator_Center"></asp:Label>
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EntitySetName="Customer_ProductSet"
        EnableUpdate="true"
        Include="Customer_Index,Customer"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.Customer_ProductId FROM Customer_Product_IndexSet AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O PRODUKCIE"/>
            </td>
</tr>
          <tr class="td">
...
<tr class="td">
 ...
 <tr class="td">
        ...
        <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="OPCJE"/>
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl='<%#"~/Customer_ProductSet/Details.aspx?Id=" + Eval("Customer_ProductId") %>'>Pokaż Wszystkie Rewizje</asp:DynamicHyperLink> | &nbsp;
                                   </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EntityDataSource3" runat="server" EnableDelete="true" />

            <asp:QueryExtender TargetControlID="DetailsDataSource" ID="QueryExtender1" runat="server">
         ...
         <%--   <h2 class="DDSubHeader">Lista części</h2>
            <asp:DynamicDataManager ID="DynamicDataManager10" runat="server"  AutoLoadForeignKeys="true">
                <DataControls>
                    <asp:DataControlReference ControlID="GridViewCustomer_Part_Indx"/>
                </DataControls>
            </asp:DynamicDataManager>

            <asp:EntityDataSource ID="EntityDataSourcePart" runat="server"
                ContextTypeName="YASA_PL.YASA_PLContainer"
                EntitySetName="Customer_Part_IndexSet"     
Where="it.Customer_Product_IndexId=@CPartId2"
                 >
                <WhereParameters>
            ...
            <asp:GridView ID="GridViewCustomer_Part_Indx" runat="server" AllowPaging="True" AllowSorting="True" CssClass="DDGridView"
                RowStyle-CssClass="td" HeaderStyle-CssClass="th" CellPadding="6"
                DataSourceID="EntityDataSourcePart" AutoGenerateColumns="false">
                <Columns>
            ...
            <div class="DDBottomHyperLink">
                <asp:HyperLink ID="HyperLink1" runat="server"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj rekord</asp:HyperLink>
            </div>--%>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server"
                ...
                Where="it.Customer_Product_IndexId=@CPartIndexId">
                <WhereParameters>
                    <asp:QueryStringParameter Name="CPartIndexId" Type="Int32" QueryStringField="Id" Direction="Input" />
                </WhereParameters>
            </asp:EntityDataSource>
            ...
            <div class="DDBottomHyperLink">
               ...
               <br />
            <%--<h2 class="DDSubHeader">Wykaz technologii:</h2>
            <asp:DynamicDataManager runat="server">
                <DataControls>
            ...
            <div class="DDBottomHyperLink">
                <asp:HyperLink ID="HyperLink4" runat="server"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj rekord</asp:HyperLink>
            </div>--%>
