...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["CNC_MachineId"];
            if (value != null)
                Response.Redirect("~/CNC_MachineSet/Details.aspx?Id=" + value);
            else
    ...
    {
        YASA_PL.CNC_Machine_Files c = (YASA_PL.CNC_Machine_Files)e.Entity;
        if (c != null)
        {
            ...
            if (c.filePath != null)
            {
                ...
                String fileUrl = "~/machine_files/" + c.filePath;
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["CNC_MachineId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/CNC_MachineSet/Details.aspx?Id=" + value3);
        }
