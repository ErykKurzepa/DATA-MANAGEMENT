...
public partial class List : System.Web.UI.Page
{
    ...
    private void AddSelections(List<int> selectionIds, List<int> selectionIds_Unchecked)
    {
        ...
        using (SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["custom_connection_YASA_PLContainer"].ConnectionString))
        {
            ...
            {
                SqlCommand cmd0 = new SqlCommand("DELETE FROM dbo.Technology_StageQuality_Chart  WHERE  [Technology_Stage_Id] = (@etap) AND [Quality_Chart_Id] = (@mach)", con);
            ...
            {
                    SqlCommand cmd1 = new SqlCommand("INSERT INTO dbo.Technology_StageQuality_Chart ([Technology_Stage_Id], [Quality_Chart_Id]) VALUES (@tool, @toolelement)", con);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (c != null)
        {
            ...
            {
                con.Open();
                SqlCommand cmd0 = new SqlCommand("SELECT COUNT(*) FROM dbo.Technology_StageQuality_Chart  WHERE  [Technology_Stage_Id] = (@etap) AND [Quality_Chart_Id] = (@element)", con);
                cmd0.Parameters.AddWithValue("@etap", value);
