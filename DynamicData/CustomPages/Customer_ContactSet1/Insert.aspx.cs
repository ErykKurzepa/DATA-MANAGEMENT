...
public partial class Insert : System.Web.UI.Page {
    ...
    {
        string value = Request.QueryString["CustomerId"];
        Session["Record_Info"] = "Rekord został dodany";
        if (value!=null)
        {
            Response.Redirect("~/CustomerSet/Details.aspx?Id=" + value);
        }
    ...
    {
        YASA_PL.Customer_Contact c = (YASA_PL.Customer_Contact)e.Entity;
        if (c != null)
        {
