...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:EntityDataSource ID="EDS2" runat="server"
        ...
        EntitySetName="CustomerSet"
        EnableUpdate="true"
        Include="Customer_Contacts, Country1"
        Where="it.Id=ANYELEMENT(SELECT VALUE s.CustomerId FROM Customer_ContactSet1 AS s WHERE s.ID=@CPartIndexId)">
        <WhereParameters>
    ...
    <h4 class="DDSubHeader">Dane firmy</h4>
...
<tr class="td">
            ...
            <td colspan="6" >
               <asp:DynamicControl DataField="Address" ID="DynamicControl2" runat="server" /><br />
                      ...
                      <asp:DynamicControl DataField="Country1" ID="DynamicControl6" runat="server" />
                 </td>
</tr>
    </table>
        </ItemTemplate>
...
<tr class="td">
            ...
            <td colspan="4">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Customer" />
                 </td>
                           </tr>
                       <tr class="td">
                                  <td style="width:150px" class="DDLightHeader">
                ...
                <asp:Label runat="server" Text="OPCJE"/>
                        ...
                        <tr class="td">
                            <td colspan="6">
                                ...
                                <asp:DynamicHyperLink DataField="Customer" runat="server" 
                                     NavigateUrl='<%#"~/CustomerSet/Details.aspx?Id="+ ((Eval("CustomerId")).ToString())%>'
