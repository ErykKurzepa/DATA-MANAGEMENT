...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O INSTRUKCJI PRACY"/>
            </td>
</tr>
      <tr class="td">
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink2" runat="server" NavigateUrl="~/Technology_InstructionSet/List.aspx">Pokaż Wszystkie Instrukcje Pracy</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="Technology_Instruction_IndexSet"
                Where="it.Technology_InstructionId=@CPartId2">
                <WhereParameters>
