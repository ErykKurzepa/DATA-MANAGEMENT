...
public partial class List : System.Web.UI.Page
{
    ...
    private void AddSelections(List<int> selectionIds, List<int> selectionIds_Unchecked)
    {
        ...
        using (SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["custom_connection_YASA_PLContainer"].ConnectionString))
        {
            ...
            {
                SqlCommand cmd0 = new SqlCommand("DELETE FROM dbo.Technology_StageTechnology_Instruction  WHERE  [Technology_Stage_Id] = (@etap) AND [Technology_Instruction_Id] = (@mach)", con);
            ...
            {   
                    SqlCommand cmd1 = new SqlCommand("INSERT INTO dbo.Technology_StageTechnology_Instruction ([Technology_Stage_Id], [Technology_Instruction_Id]) VALUES (@tool, @toolelement)", con);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (c != null)
        {
            ...
            {
                con.Open();
                SqlCommand cmd0 = new SqlCommand("SELECT COUNT(*) FROM dbo.Technology_StageTechnology_Instruction  WHERE  [Technology_Stage_Id] = (@etap) AND [Technology_Instruction_Id] = (@element)", con);
                cmd0.Parameters.AddWithValue("@etap", value);
