       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink2" runat="server" NavigateUrl="~/Quality_InstructionSet/List.aspx">Pokaż Wszystkie Instrukcje Kontroli</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="Quality_Instruction_IndexSet"
                Where="it.Quality_InstructionId=@CPartId2">
                <WhereParameters>
