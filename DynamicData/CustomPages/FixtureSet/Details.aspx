...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O PRZYRZĄDZIE"/>
            </td>
</tr>
                                                           <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Id przyrządu"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl5" DataField="Id"/>
                                                     ...
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Nazwa przyrządu"/>
            </td>
            <td colspan="6">
...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl2" DataField="Description"/>
                          ...
                          <tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="DANE DOSTAWCY"/>
            </td>
</tr>
                       
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Nazwa dostawcy"/>
            </td>
            <td colspan="6">
...
<tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Numer zamówienia"/>
            </td>
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Contractor_Order"/>
                 </td>
</tr>
                            <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:DynamicHyperLink runat="server" Action="Edit" Text="Edytuj" ID="EditDynamicHyperLink" /> | &nbsp;
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl="~/FixtureSet/List.aspx">Pokaż Wszystkie Przyrządy</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <br />
            <h2 class="DDSubHeader">Dokumentacja przyrządu</h2>
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" EnableDelete="true"
                ...
                EntitySetName="Fixture_Document_FileSet"
                Where="it.FixtureId=@CPartIndexId"
                 Include="Fixture_Document_Type">
                <WhereParameters>
            ...
            <asp:GridView ID="GridViewCustomer_Part_Index_Files" runat="server" AllowPaging="True" AllowSorting="True" CssClass="DDGridView" OnRowDeleted="GridViewCustomer_Part_Index_Files_RowDeleted"
                ...
                <Columns>
                   ...
                   <asp:DynamicField DataField="File_title"/>
                     <asp:DynamicField DataField="Fixture_Document_Type"/>
                    <asp:DynamicField DataField="Description" ItemStyle-Width="65%"/>
