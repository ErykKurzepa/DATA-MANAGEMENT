...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="Contractor" Mode="Edit"/>
                 </td>
</tr>
<tr class="td">
            <td style="width:150px" class="DDLightHeader">
            ...
            <td colspan="6">
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Contractor_Order" Mode="Edit"/>
                 </td>
</tr>
                            <tr class="td">
        <td class="User_page_header" colspan="6">
