...
<asp:Button runat="server" OnClick="clear_search"  Text="Wyczyść"/>
           ...
           <hr />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" EnablePersistedSelection="true"
                ...
                <Columns>
                     <asp:DynamicField DataField="Id" ItemStyle-Width ="150px" HeaderText="Numer<br>inwentaryzacyjny" />
                     <asp:DynamicField DataField="CNC_Machine_Type" />
                     <asp:DynamicField DataField="Tool_Holder_System"/>
                     <asp:DynamicField DataField="Name" />
                     <asp:DynamicField DataField="Serial_number" />
                     <asp:DynamicField DataField="Manufacturer" />
                    <asp:DynamicField DataField="Model" />
                   
                     <asp:DynamicField DataField="Control" />
                     <asp:DynamicField DataField="Date_purchased" />
                     <asp:TemplateField>
                        <ItemTemplate>
            ...
            <div class="DDBottomHyperLink">
                <asp:DynamicHyperLink ID="InsertHyperLink" runat="server" Action="Insert"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj maszynę</asp:DynamicHyperLink> | &nbsp;
                 <asp:DynamicHyperLink ID="DynamicHyperLink1" runat="server" NavigateUrl="~/CNC_Machine_TypeSet/Insert.aspx"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj nowy rodzaj maszyny</asp:DynamicHyperLink> | &nbsp;
             <asp:DynamicHyperLink ID="DynamicHyperLink2" runat="server" NavigateUrl="~/Tool_Holder_SystemSet/Insert.aspx"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj nowy sposób mocowania narzędzia</asp:DynamicHyperLink> | &nbsp;
                 </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
