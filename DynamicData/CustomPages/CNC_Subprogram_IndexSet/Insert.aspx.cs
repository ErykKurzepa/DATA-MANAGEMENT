...
public partial class Insert : System.Web.UI.Page {
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e) {
        if (e.CommandName == DataControlCommands.CancelCommandName) {
            ...
            string value1 = Request.QueryString["CNC_SubprogramId"];
            if (value1 != null)
                Response.Redirect("~/CNC_SubprogramSet/Details.aspx?Id=" + value1);
            else
    ...
    {
        YASA_PL.CNC_Subprogram_Index c = (YASA_PL.CNC_Subprogram_Index)e.Entity;
        if (c != null)
        {
    ...
    {
        string value = Request.QueryString["CNC_SubprogramId"];
        if (value != null)
        {
            Session["Record_Info"] = "Rewizja została dodana";
            Response.Redirect("~/CNC_SubprogramSet/Details.aspx?Id=" + value);
        }
