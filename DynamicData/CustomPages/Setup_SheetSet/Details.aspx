...
<tr class="td">
            ...
            <td colspan="6">
                <asp:DynamicControl   runat="server" ID="DynamicControl4" DataField="CNC_Program"  UIHint="ManyToManyTechnology" />
               </td>
            ...
            <td colspan="6">
                <asp:DynamicControl   runat="server" ID="DynamicControl5" DataField="CMM_Program"  UIHint="ManyToManyTechnology"/>
               </td>
       ...
       <tr class="td">
        <td class="User_page_header" colspan="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                ...
                                <asp:LinkButton runat="server" CommandName="Delete" Text="Usuń" ID="DeleteLinkButton"
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink2" runat="server" NavigateUrl="~/Setup_SheetSet/List.aspx">Pokaż Wszystkie Arkusze Ustawcze</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
            ...
            <asp:EntityDataSource ID="EDS1" runat="server"
                ...
                EntitySetName="Setup_Sheet_IndexSet"
                Where="it.Setup_SheetId=@CPartId2">
                <WhereParameters>
