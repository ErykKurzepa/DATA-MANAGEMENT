...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:DynamicDataManager ID="DynamicDataManager1" runat="server" AutoLoadForeignKeys="true">
     ...
     <h2 class="DDSubHeader">
         <asp:Label ID="Label1" runat="server" Text="Label" >Księga jakości, Procedury Systemowe, Procesy</asp:Label></h2>
    <hr />
 ...
 <asp:TextBox ID="TBSearch" CssClass="DDTextBox" runat="server" ></asp:TextBox> 
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <b>Filtry:</b> 
                ...
                <asp:QueryExtender ID="QE1" runat="server" TargetControlID="GridDataSource">
                    ...
                    <asp:SearchExpression DataFields="Id, Title, Description" ComparisonType="InvariantCultureIgnoreCase" SearchType="Contains">
