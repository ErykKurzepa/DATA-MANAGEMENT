...
<tr class="td">
            <td class="User_page_header" colspan="6">
                <asp:Label runat="server" Text="INFORMACJE O DOKUMENTACJI"/>
            </td>
</tr>
                           <tr class="td">
            ...
            <td>
                <asp:DynamicControl  runat="server" ID="DynamicControl4" DataField="Id" />
                                                     ...
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
                <asp:Label runat="server" Text="Typ dokumentacji"/>
            </td>
            <td colspan="3">
                <asp:DynamicControl  runat="server" ID="DynamicControl3" DataField="QualityDocumentationType" />
                 </td>
</tr>
                                                     <tr class="td">
            <td style="width:150px" class="DDLightHeader">
...
<tr class="td">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:DynamicHyperLink runat="server" Action="Edit" Text="Edytuj" ID="EditDynamicHyperLink" /> | &nbsp;
                                 ...
                                 <asp:DynamicHyperLink ID="ListHyperLink" runat="server" NavigateUrl="~/QualityDocumentationSet/List.aspx">Pokaż Wszystkie Dokumentacje</asp:DynamicHyperLink> | &nbsp;
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
        ...
        <br />
            ...
            <asp:EntityDataSource ID="EntityDataSource1" runat="server" EnableDelete="true"
                ...
                EntitySetName="QualityDocumentation_FilesSet"
                Where="it.QualityDocumentationId=@CPartIndexId">
                <WhereParameters>
