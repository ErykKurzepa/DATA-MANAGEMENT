...
public partial class Insert : System.Web.UI.Page
{
    ...
    protected void FormView1_ItemCommand(object sender, FormViewCommandEventArgs e)
    {
        ...
        {
            string value = Request.QueryString["Quality_Instruction_IndexId"];
            if (value != null)
                Response.Redirect("~/Quality_Instruction_IndexSet/Details.aspx?Id=" + value);
            else
    ...
    protected void Show_Record(object sender, EntityDataSourceChangedEventArgs e)
    {
        ...
        string value3 = Request.QueryString["Quality_Instruction_IndexId"];
        if (value3 != null)
        {
            Session["Record_Info"] = "Plik został dodany";
            Response.Redirect("~/Quality_Instruction_IndexSet/Details.aspx?Id=" + value3);
        }
