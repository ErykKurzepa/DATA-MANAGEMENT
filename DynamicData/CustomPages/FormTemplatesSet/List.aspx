...
<asp:Button runat="server" OnClick="clear_search"  Text="Wyczyść"/>
           ...
           <hr />
                ...
                <Columns>
                   <asp:DynamicField DataField="Id" HeaderText="Id" /> 
                    ...
                    <asp:DynamicField DataField="Description" />
                            <asp:DynamicField DataField="FormType" />
            ...
            <div class="DDBottomHyperLink">
                <asp:DynamicHyperLink ID="InsertHyperLink" runat="server" Action="Insert"><img runat="server" src="~/DynamicData/Content/Images/plus.gif" alt="Insert new item" />Dodaj formularz</asp:DynamicHyperLink>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
