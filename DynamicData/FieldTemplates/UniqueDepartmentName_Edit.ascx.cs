...
using System.Linq;
    ...
    public partial class UniqueNameDepartment_EditField : System.Web.DynamicData.FieldTemplateUserControl
    {
        ...
        protected void IsUserNameUnique(object sender, EventArgs e)
        {
            ...
            Int64 licznik = 0;
            var users = from u in x.Departments
                        select u;
            ...
            if (licznik > 0)
            {
                RegularExpressionValidator1.ErrorMessage = "Podany nazwa działu już istnieje";
